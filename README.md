...
<img src="http://g.recordit.co/tkdNlj1aU4.gif" width=250><br>

### Notes
Describe any challenges encountered while building the app.
---
1. Found difficult to set autolayout for the UICollectionViewCell. On smaller screen devices, one cell is displayed in each row.
